...
export function UsdcIcon(props: LucideProps) {
  return (
    <svg data-name="86977684-12db-4850-8f30-233a7c267d11" xmlns="http://www.w3.org/2000/svg" height="100%" width="100%" viewBox="0 0 2000 2000" {...props}>
...
export function SolIcon(props: LucideProps) {
  return (
    ...
    >
      ...
      <path
        className="st1"
        d="M64.6,3.8c2.4-2.4,5.7-3.8,9.2-3.8h317.4c5.8,0,8.7,7,4.6,11.1l-62.7,62.7c-2.4,2.4-5.7,3.8-9.2,3.8H6.5c-5.8,0-8.7-7-4.6-11.1L64.6,3.8z"
      />
      <linearGradient
        id="SVGID_3_"
        gradientUnits="userSpaceOnUse"
